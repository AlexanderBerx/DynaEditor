...
class EnumWidget(BaseWidget):
    ...
    """
    def __init__(self, data_type, attr, default_value, options, nice_name=None):
        """
        ...
        super(EnumWidget, self).__init__(data_type, attr, default_value, nice_name)
